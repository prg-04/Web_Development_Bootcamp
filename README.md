...
# 📖 [Web-Dev Bootcamp] <a name="about-project"></a>

**[Web Dev Bootcamp]** is an online Bootcamp where you'll learn all about Web Development and launch your career as a Frontend Developer
...
- [Live Demo Link](https://www.loom.com/share/31e98b4f21524cadb89c0a15e39d1000)
...
- Login to your github account and search for 'prg-04/Web_Development_Bootcamp/'
...
- After cloning the repository change the directory using 'cd Web_Development_Bootcamp/' to access the files.
...
- In your terminal window type: git clone https://github.com/prg-04/Web_Development_Bootcamp

### Usage

To run the project, execute the following command:

- code Web_Development_Bootcamp .
...
Feel free to check the [issues page](https://github.com/prg-04/Web_Development_Bootcamp/issues).
